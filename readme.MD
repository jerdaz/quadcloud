...
4. **Start the app** – run `quadcloud.bat`. The script updates the source from GitHub, installs the latest Electron and dependencies, and launches the application.
