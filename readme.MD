...
Each view can spoof browser focus to prevent the "click to continue" overlay on xCloud. Toggle this behavior per quadrant via the `SPOOF_FOCUS` array in [`main.js`](main.js).
